/*
  ESP32 + BME280 Hydroponics Environment Logger v6.2
  ------------------------------------------------
  Features
...
<footer>오늘 화면의 시간축은 항상 현지시간 00:00–24:00으로 고정됩니다. 7일은 10분 평균, 30일은 1시간 평균입니다. Y축은 데이터에 따라 움직이되 최소 표시 폭을 유지합니다.</footer>
</main><script>
