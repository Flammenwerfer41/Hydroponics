...
test("count query covers every portable table", () => {
  ...
  for (const table of ["journal_days", "journal_sections", "journal_tags", "journal_section_tags", "journal_day_values", "journal_photos", "journal_crop_photos", "r2_cleanup_queue"]) {
